...
.nav-item { display: flex; align-items: center; gap: 12px; padding: 14px 16px; font-size: 14px; font-weight: 900; color: var(--text-primary); text-decoration: none; border: 2px solid transparent; transition: all 0.1s; letter-spacing: 0.05em; }
