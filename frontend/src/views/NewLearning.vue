...
.brutal-panel { background: transparent; border: 1px solid var(--border); padding: 32px; display: flex; flex-direction: column; border-radius: 0; transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1); }
.form-panel { padding: 32px; border-radius: 0; }
.form-panel:hover { border-color: var(--text-primary); } /* hover effect updated */
...
.option-btn { background: transparent; border: 1px solid var(--border); padding: 20px; cursor: pointer; text-align: left; display: flex; align-items: flex-start; gap: 16px; transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1); border-radius: 0; font-family: inherit; }
.option-btn:hover { border-color: var(--text-primary); background: var(--bg-hover); }
.option-btn.selected { border-color: var(--text-primary); background: transparent; }
