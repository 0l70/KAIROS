...
.brutal-panel:hover { border-color: var(--text-primary); }
...
.option-btn { background: var(--bg-surface); border: 1px solid var(--border); padding: 16px 20px; cursor: pointer; text-align: left; display: flex; align-items: flex-start; gap: 12px; transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1); border-radius: 0; font-family: inherit; }
...
.brutal-modal { width: 100%; display: flex; flex-direction: column; background: var(--bg-surface); border: 1px solid var(--border); animation: fadeUp 0.4s cubic-bezier(0.16, 1, 0.3, 1) both; border-radius: 0; }
