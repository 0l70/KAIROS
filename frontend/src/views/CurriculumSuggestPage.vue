  ...
  <div class="modal-root">
    <div class="modal-card">
      <div class="modal-header">
        ...
        <button class="btn-close" @click="$router.push('/analysis')"><i class="fas fa-times" /></button>
      </div>
      ...
      <div class="modal-body">
        ...
        <h3 class="section-title"><i class="fas fa-book-open" /> 제안된 학습 주제</h3>
        ...
        <h3 class="section-title"><i class="fas fa-lightbulb" /> 추천 이유 요약</h3>
...
<style scoped>
.modal-root { min-height: 100vh; display: flex; align-items: center; justify-content: center; background: rgba(0,0,0,0.4); font-family: 'Escoredream', sans-serif; padding: 20px; }
.modal-card { width: 100%; max-width: 540px; background: #fff; border-radius: 16px; box-shadow: 0 10px 40px rgba(0,0,0,0.1); overflow: hidden; }
...
.topic-item { display: flex; gap: 14px; padding: 16px; border: 1px solid #eaeaea; border-radius: 10px; }
.dot { width: 8px; height: 8px; background: #bbb; border-radius: 50%; margin-top: 5px; flex-shrink: 0; }
...
.btn-primary { background: #111; border: none; padding: 12px 28px; border-radius: 8px; font-size: 13px; font-weight: 600; color: #fff; cursor: pointer; font-family: inherit; transition: background 0.2s; }
